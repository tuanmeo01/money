...
export const fetchAllUsers = createAsyncThunk<HeaderResponse<BaseUserResponse>, number>(
    "admin/fetchAllUsers",
    async (page) => {
...
export const fetchAllUsersByQuery = createAsyncThunk<Array<BaseUserResponse>>(
